...
<nav class="floating-pills-nav fixed-top" id="uniqueNavbar">
  <div class="nav-container">
    ...
    <div class="nav-pills-container" id="navPillsContainer">
      <div class="nav-pill" data-delay="0"><a href="#about">About</a></div>
      <div class="nav-pill summer-camp-nav-pill" data-delay="100"><a href="#summer-camp">Summer Camp</a></div>
      <div class="nav-pill" data-delay="150"><a href="#after-school">After School</a></div>
              <div class="nav-pill" data-delay="175"><a href="#after-school">Weekend & Evening</a></div>
      <div class="nav-pill" data-delay="185"><a href="#online-store">Online Store</a></div>
      <div class="nav-pill" data-delay="195"><a href="#belt-exam">Belt Exam</a></div>
      <div class="nav-pill" data-delay="200"><a href="#kaizen-kenpo">Kaizen Kenpo</a></div>
      <div class="nav-pill" data-delay="205"><a href="#contact">Contact</a></div>
  ...
  <div class="mobile-overlay-menu" id="mobileOverlayMenu">
    <div class="mobile-menu-content">
      ...
      <div class="mobile-nav-items">
        <a href="#about" class="mobile-nav-item" data-delay="0">About</a>
        <a href="#summer-camp" class="mobile-nav-item summer-camp-mobile-nav" data-delay="100">Summer Camp</a>
        <a href="#after-school" class="mobile-nav-item" data-delay="150">After School</a>
        <a href="#after-school" class="mobile-nav-item" data-delay="175">Weekend & Evening</a>
        <a href="#online-store" class="mobile-nav-item" data-delay="185">Online Store</a>
        <a href="#belt-exam" class="mobile-nav-item" data-delay="195">Belt Exam</a>
        <a href="#kaizen-kenpo" class="mobile-nav-item" data-delay="200">Kaizen Kenpo</a>
  ...
  <div class="fixed-sidebar-widget">
    ...
    <div class="sidebar-button">
      <a href="#" target="_blank" class="sidebar-btn" title="Follow us on TikTok">
      ...
      <div class="row h-100">
        ...
        <div class="col-12">
          <div class="hero-content" id="heroContent">
            <button class="hero-close-btn" id="heroCloseBtn" title="Close overlay to watch video" onclick="document.getElementById('heroContent').classList.add('hidden')">&times;</button>
            ...
            <p class="hero-description">
              Kaizen Karate has offered martial arts instruction since 2003. Founded by Coach V, we specialize in karate instruction for children of all ages in the <span class="hero-locations">Washington DC, Maryland, and Northern Virginia</span> areas. We also offer karate programs for adults with a focus on fitness and self-defense. <a href="#about" class="hero-read-more-inline">Read more</a>
            </p>
            <a href="https://www.gomotionapp.com/team/mdkfu/page/class-registration" target="_blank" class="btn training-btn-black hero-registration-btn">Register Now</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row g-4 training-cards-grid">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-6">
          <div class="training-card h-100 animate-in">
            ...
            <div class="training-card-content">
              ...
              <p class="training-description">Safe, structured environment where children learn traditional karate while developing discipline, respect, and confidence. Perfect for working parents.</p>
              <div class="training-card-buttons">
                <a href="#after-school" class="btn training-btn-primary">Learn More →</a>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-6">
          <div class="training-card h-100 animate-in">
            ...
            <div class="training-card-image">
              <img src="assets/images/weekend-evening/weekend-evening-may-june.png" alt="Weekend and evening karate classes for busy schedules" class="card-image">
            </div>
            <div class="training-card-content">
              <p class="training-summary">Flexible scheduling for adults and families with busy weekday commitments.</p>
              <p class="training-description">Traditional karate training designed to fit your lifestyle. Weekend and evening classes accommodate work and school schedules while maintaining authentic instruction.</p>
              <div class="training-card-buttons">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-6">
          <div class="training-card h-100 animate-in">
            ...
            <div class="training-card-content">
              ...
              <p class="training-description">Belt exams are invitation-only and students must be invited by their instructor to test. Our rigorous testing ensures authentic skill development and progression.</p>
              <div class="training-card-buttons">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-6">
          <div class="training-card h-100 animate-in">
            ...
            <div class="training-card-image">
              <img src="assets/images/online-store/online-store.jpg" alt="Kaizen Karate online store for equipment and merchandise" class="card-image">
            </div>
            <div class="training-card-content">
              <p class="training-summary">Quality karate equipment, uniforms, and Kaizen Karate merchandise.</p>
              <p class="training-description">Everything you need for your karate journey - from beginner gear to advanced equipment. Support your training with authentic, high-quality items.</p>
              <div class="training-card-buttons">
...
<section id="about" class="about-dark-section">
  <div class="container-fluid">
    <div class="about-content-wrapper">
      ...
      <p class="about-text">
        Kaizen Karate now operates 7 days per week throughout Maryland, Washington D.C., and Virginia.
      </p>

      <h2 class="about-section-title mt-5 mb-4">Meet Coach V</h2>
      
      <p class="about-text">
        "Coach V" has 37 years of experience in the martial arts, having spent the majority of his life committed to the trade. He began his journey with karate at five years old and earned his first black belt in non-traditional Tang Soo Do in 1998 through Hill's Hitters Karate and Master Instructor Dr. Phillip Hill.
      </p>
...
<section id="summer-camp" class="py-5" style="background-color: #f8f9fa;">
  <div class="container">
    ...
    <p class="text-center mb-4 summer-camp-subtitle">4 campsites for campers ages 5-12</p>
    ...
    <div class="row align-items-stretch mb-5">
            ...
            <div class="row align-items-stretch">
              ...
              <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
                <div class="registration-info-card">
                  <div class="clean-deadline-notice">
                    <i class="fas fa-calendar-alt"></i>
                    <span class="clean-deadline-text">Early registration deadline <strong>March 31st, 2025</strong></span>
                  </div>
                  
                  <div class="clean-special-offer">
                    <i class="fas fa-gift"></i>
                    <div class="clean-offer-content">
                      <span class="clean-offer-main"><strong>FREE before & after care</strong> for ALL weeks when you register before March 31st, 2025</span>
                      <span class="clean-offer-savings">(savings of up to $150 per week)</span>
                    </div>
                  </div>
                  
                  <div class="clean-camp-details">
              ...
              <!-- Right Column: Registration Buttons -->
              <div class="col-lg-6 col-md-12">
                <div class="registration-action-card">
      ...
      <div class="row justify-content-center mt-4">
        <div class="col-lg-10">
            ...
            <div class="master-instructor-accordion">
              <button class="master-instructor-header">
                <h2 class="about-section-title mt-5 mb-4">More Information about Summer Camp 2025</h2>
                <span class="master-accordion-icon">▼</span>
              </button>
                  ...
                  <div class="instructor-item">
                    ...
                    <div class="instructor-content" id="instructor-camp10">
                      <div style="color: var(--text-dark);">
                        ...
                        <!-- Mailing Address -->
                        <div style="margin-bottom: 0;">
                          <h4 style="color: var(--accent); margin-bottom: 15px;">Mailing Address</h4>
                          <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; border-left: 4px solid var(--accent);">
                            <p style="margin-bottom: 0; color: var(--text-dark); font-weight: 600;">Kaizen Karate<br>
                            PO Box 221<br>
                            Spencerville, MD 20868</p>
                          </div>
                          <p style="margin-top: 15px; margin-bottom: 0; color: var(--text-dark);">Phone: 301-938-2711</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
<section id="after-school" class="py-5" style="background: linear-gradient(135deg, #1a1a1a 0%, #2c2c2c 100%); color: white;">
  <div class="container">
    <h2 class="text-center mb-5" style="color: white; font-family: 'Playfair Display', serif; font-size: 3rem; font-weight: 700;"><span style="text-decoration: underline; text-underline-offset: 0.3em; text-decoration-color: #dc3545;">After School</span>  <span style="margin: 0 0.5rem;">•</span>  <span style="text-decoration: underline; text-underline-offset: 0.3em; text-decoration-color: #dc3545;">Weekend & Evening</span></h2>
            ...
            <div class="filter-group">
              ...
              <div class="custom-dropdown" data-filter="belt-level">
                ...
                <div class="dropdown-options">
                  ...
                  <div class="dropdown-option" data-value="master-form">Master Form / Kenpo</div>
                </div>
              </div>
            </div>
    ...
    <!-- May-June Schedule and Registration Containers -->
    <div class="row justify-content-center g-4 mt-5">
      ...
      <div class="col-lg-6">
        <div style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 2rem; border: 1px solid rgba(255, 255, 255, 0.1); text-align: center; height: 100%;">
          <h3 style="color: #dc3545; font-size: 1.5rem; margin-bottom: 1.5rem; font-weight: 600;">May - June Schedule</h3>
          
          <!-- Calendar Preview -->
          <div style="position: relative; margin-bottom: 1.5rem;">
            <img src="assets/images/aftersschool/may-june-karate.png" 
                 alt="May-June Karate Schedule" 
          ...
          <!-- Download Button -->
          <a href="assets/images/aftersschool/may-june-karate.png" 
             download="Kaizen-Karate-May-June-2025.png"
...
<div id="calendarLightbox" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.95); display: none; align-items: center; justify-content: center; z-index: 9999; opacity: 0; transition: opacity 0.3s ease;" onclick="closeCalendarPreview()">
  <div style="position: relative; max-width: 90vw; max-height: 90vh;">
    <img src="assets/images/aftersschool/may-june-karate.png" 
         alt="May-June After School Karate Schedule - Full Size" 
...
<div id="brownStripeLightbox" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.95); display: none; align-items: center; justify-content: center; z-index: 9999; opacity: 0; transition: opacity 0.3s ease;" onclick="closeBrownStripeLightbox()">
  <div style="position: relative; max-width: 90vw; max-height: 90vh;">
...
<div id="redBeltLightbox" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.95); display: none; align-items: center; justify-content: center; z-index: 9999; opacity: 0; transition: opacity 0.3s ease;" onclick="closeRedBeltLightbox()">
   <div style="position: relative; max-width: 90vw; max-height: 90vh;">
...
<section id="online-store" class="py-5" style="background: #ffffff; color: #333;">
  <div class="container">
      ...
      <div style="background: rgba(255, 255, 255, 0.05); border-radius: 15px; padding: 0; border: 1px solid rgba(255, 255, 255, 0.1); overflow: hidden;">
        ...
        <div class="accordion-item" style="border: none; background: transparent;">
          ...
          <div class="accordion-content" id="register-content" style="display: none; padding: 2rem; background: rgba(0, 0, 0, 0.2);">
            <div style="color: #e9ecef; line-height: 1.8;">
              <p style="margin-bottom: 1.5rem; font-size: 1.1rem;">Ready to register for your belt examination? Follow these steps:</p>
              ...
              <div class="text-center">
                <a href="https://www.gomotionapp.com/team/mdkfu/page/belt-exam-registration" 
                   target="_blank"
                   style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); color: white; padding: 1.5rem 3rem; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 1.3rem; display: inline-block; transition: all 0.3s ease; box-shadow: 0 6px 20px rgba(220, 53, 69, 0.4); margin-bottom: 1.5rem;"
                   onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 8px 25px rgba(220, 53, 69, 0.6)';"
                   onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 6px 20px rgba(220, 53, 69, 0.4)';">
                  <i class="fas fa-external-link-alt" style="margin-right: 0.8rem;"></i>
                  Register Online
                </a>
                
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">
                  Questions about registration? <a href="#contact" style="color: #dc3545; text-decoration: underline;">Contact our office</a> directly.
                </p>
          </div>
        </div>
          </div>
...
<section id="kaizen-kenpo" class="py-5" style="background: #ffffff; color: #333; position: relative; overflow: hidden;">
  <!-- Artistic Background Blobs -->
  <!-- Large Impact Blobs -->
  <div style="position: absolute; top: -150px; left: -150px; width: 500px; height: 500px; background: radial-gradient(circle, rgba(220, 53, 69, 0.12) 0%, rgba(220, 53, 69, 0.06) 40%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: -120px; right: -180px; width: 600px; height: 600px; background: radial-gradient(circle, rgba(44, 62, 80, 0.10) 0%, rgba(44, 62, 80, 0.04) 45%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 30%; right: -200px; width: 450px; height: 450px; background: radial-gradient(circle, rgba(220, 53, 69, 0.09) 0%, rgba(220, 53, 69, 0.03) 50%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: 10%; left: -100px; width: 380px; height: 380px; background: radial-gradient(circle, rgba(44, 62, 80, 0.08) 0%, rgba(44, 62, 80, 0.02) 60%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  
  <!-- Medium Impact Blobs -->
  <div style="position: absolute; top: 50%; left: 70%; transform: translate(-50%, -50%); width: 320px; height: 320px; background: radial-gradient(circle, rgba(220, 53, 69, 0.08) 0%, rgba(220, 53, 69, 0.03) 60%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 10%; left: 25%; width: 280px; height: 280px; background: radial-gradient(circle, rgba(44, 62, 80, 0.07) 0%, transparent 70%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: 25%; right: 15%; width: 350px; height: 350px; background: radial-gradient(circle, rgba(220, 53, 69, 0.06) 0%, transparent 75%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 65%; left: 15%; width: 290px; height: 290px; background: radial-gradient(circle, rgba(44, 62, 80, 0.06) 0%, transparent 65%); border-radius: 50%; z-index: 1;"></div>
  
  <!-- Additional Artistic Blobs -->
  <div style="position: absolute; top: 15%; right: 5%; width: 240px; height: 240px; background: radial-gradient(circle, rgba(220, 53, 69, 0.08) 0%, rgba(220, 53, 69, 0.03) 60%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 75%; left: 45%; width: 220px; height: 220px; background: radial-gradient(circle, rgba(44, 62, 80, 0.06) 0%, transparent 65%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: -50px; left: 40%; width: 310px; height: 310px; background: radial-gradient(circle, rgba(220, 53, 69, 0.05) 0%, transparent 80%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: 40%; right: -80px; width: 360px; height: 360px; background: radial-gradient(circle, rgba(44, 62, 80, 0.07) 0%, rgba(44, 62, 80, 0.02) 55%, transparent 100%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 30%; left: -60px; width: 270px; height: 270px; background: radial-gradient(circle, rgba(220, 53, 69, 0.06) 0%, transparent 75%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: -40px; left: 60%; width: 200px; height: 200px; background: radial-gradient(circle, rgba(44, 62, 80, 0.05) 0%, transparent 70%); border-radius: 50%; z-index: 1;"></div>
  
  <!-- Extra Dense Artistic Elements -->
  <div style="position: absolute; top: 5%; left: 60%; width: 180px; height: 180px; background: radial-gradient(circle, rgba(220, 53, 69, 0.07) 0%, transparent 70%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 85%; right: 30%; width: 160px; height: 160px; background: radial-gradient(circle, rgba(44, 62, 80, 0.05) 0%, transparent 65%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 40%; left: 5%; width: 210px; height: 210px; background: radial-gradient(circle, rgba(220, 53, 69, 0.04) 0%, transparent 75%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: 60%; right: 45%; width: 190px; height: 190px; background: radial-gradient(circle, rgba(44, 62, 80, 0.04) 0%, transparent 70%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 20%; right: 25%; width: 230px; height: 230px; background: radial-gradient(circle, rgba(220, 53, 69, 0.05) 0%, transparent 65%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: 15%; left: 35%; width: 170px; height: 170px; background: radial-gradient(circle, rgba(44, 62, 80, 0.06) 0%, transparent 75%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; top: 55%; right: 8%; width: 250px; height: 250px; background: radial-gradient(circle, rgba(220, 53, 69, 0.06) 0%, transparent 68%); border-radius: 50%; z-index: 1;"></div>
  <div style="position: absolute; bottom: 5%; right: 60%; width: 140px; height: 140px; background: radial-gradient(circle, rgba(44, 62, 80, 0.05) 0%, transparent 72%); border-radius: 50%; z-index: 1;"></div>
  
  <div class="container" style="position: relative; z-index: 2;">
    <h2 class="text-center mb-5" style="color: #2c3e50; font-family: 'Playfair Display', serif; font-size: 3rem; font-weight: 700; text-decoration: underline; text-underline-offset: 0.3em; text-decoration-color: #dc3545;">Kaizen Kenpo</h2>
    
    <div class="row align-items-center g-4">
      <!-- Kenpo Logo -->
      <div class="col-lg-6">
        <div style="text-align: center;">
          <img src="assets/images/kenpo/kenpo-logo.png" 
               alt="Kaizen Kenpo Logo - Chinese Kenpo Martial Arts" 
      ...
      <div class="col-lg-6">
        <div style="padding: 2rem;">
          <div style="background: rgba(220, 53, 69, 0.05); border-radius: 15px; padding: 2.5rem; border: 1px solid rgba(220, 53, 69, 0.1); text-align: center;">
            <p style="color: #495057; font-size: 1.3rem; line-height: 1.8; margin-bottom: 2.5rem; font-weight: 400;">
              Learn more about our invite-only program in the art of Chinese Kenpo. We serve the DC Metro area including Maryland, DC, and Northern Virginia. Kaizen Kenpo is a division of Kaizen Karate LLC.
            </p>
            
            <!-- Learn More Button -->
            <a href="https://www.kaizenkenpo.net/" 
               target="_blank"
               style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); color: white; padding: 1.5rem 3.5rem; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 1.4rem; display: inline-block; transition: all 0.3s ease; box-shadow: 0 6px 20px rgba(220, 53, 69, 0.5); border: none;"
               onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 8px 25px rgba(220, 53, 69, 0.7)';"
               onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 6px 20px rgba(220, 53, 69, 0.5)';">
              <i class="fas fa-external-link-alt" style="margin-right: 0.8rem; font-size: 1.2rem;"></i>
              Learn More
            </a>
            
            <p style="color: #6c757d; margin-top: 1.5rem; font-size: 0.95rem; font-style: italic;">
              Invitation-only program • Advanced martial arts training
        </p>
      </div>
    </div>
    </div>
...
<section id="contact" class="contact-section" style="background: linear-gradient(135deg, #1a1a1a 0%, #2c2c2c 100%); color: white;">
  <div class="container">
    ...
    <form id="waitListForm" action="form-handler.php" method="POST" class="contact-form" style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.2);">
    ...
    <div id="waitlistThankYou" class="waitlist-thankyou text-center" style="color: white;">
      <h4 style="color: white;">Thank you!</h4>
      <p style="color: #e9ecef;">We've received your message and will contact you soon to discuss your training options.</p>
    </div>
  </div>
</section>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="footer-brand">
            ...
            <p class="footer-description">
              Traditional martial arts training in Washington DC, Maryland, and Northern Virginia. 
        ...
        <div class="footer-contact">
            ...
            <div class="contact-item">
              ...
              <span>(555) 123-DOJO</span>
            </div>
            <div class="contact-item">
              <i class="fas fa-envelope"></i>
              <span>info@kaizenkarate.com</span>
      </div>
    </div>
...
<div id="summerCampVideoLightbox" class="summer-camp-lightbox">
  <div class="summer-camp-lightbox-content">
    ...
    <div class="summer-camp-video-wrapper">
      <video id="summerCampVideo" class="summer-camp-lightbox-video" controls>
  ...
  <script>
    ...
    window.openSummerCampVideo = function() {
      ...
      if (lightbox && video) {
        ...
        alert("redBeltLightbox NOT FOUND!");
      }        
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (lightbox) {
        alert("brownStripeLightbox found!");
  ...
  <script>
    ...
    window.openBrownStripeLightbox = function() {
      alert("Brown Stripe Script clicked!");      const lightbox = document.getElementById('brownStripeLightbox');
    ...
    // Cache buster and function verification
    console.log('Red Belt function exists:', typeof window.openRedBeltLightbox);
    console.log('Brown Stripe function exists:', typeof window.openBrownStripeLightbox);
    console.log('Red Stripe function exists:', typeof window.openRedStripeLightbox);
    
    // Test function to verify functions work
