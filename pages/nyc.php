...
<head>
  ...
  <title>Kaizen Karate NYC | After School Programs</title>
  <meta name="description" content="Kaizen Karate After School Programs in NYC Public Schools.">
  ...
  <!-- NYC Specific Styles -->
  <link rel="stylesheet" href="modules/nyc/nyc-style.css?v=<?php echo time(); ?>">
  ...
  <style>
      /* Ensure NYC specific overrides if necessary */
      :root {
          --primary-color: #a4332b;
      }
  </style>
</head>
<body>
...
<?php include __DIR__ . '/../sections/nyc-section.php'; ?>
