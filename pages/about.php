...
<head>
  ...
  <title><?php echo display_text('site_info', 'title', 'Kaizen Karate | Traditional Martial Arts Training'); ?> | About</title>
  <meta name="description" content="Learn about Kaizen Karate, Coach V, and our instructor team.">
