      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
          ...
          <ul class="quick-links-list">
            ...
            <li><a href="index.php#weekend-evening">After School</a></li>
            <li><a href="index.php#weekend-evening">Weekend Classes</a></li>
            <li><a href="index.php#kaizen-dojo">Kaizen Dojo</a></li>
