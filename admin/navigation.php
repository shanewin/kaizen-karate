                            ...
                            <div id="multiple_belt_fields" style="<?php echo ($register_dropdown['belt_exams']['display_mode'] ?? 'simple') === 'simple' ? 'display: none;' : ''; ?>">
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="belt_exams_num_buttons" id="belt_exams_num_buttons" onchange="updateBeltExamButtons()">
                                        <option value="1" <?php echo (int)($register_dropdown['belt_exams']['num_buttons'] ?? 1) === 1 ? 'selected' : ''; ?>>1</option>
                                        <option value="2" <?php echo (int)($register_dropdown['belt_exams']['num_buttons'] ?? 1) === 2 ? 'selected' : ''; ?>>2</option>
                                        <option value="3" <?php echo (int)($register_dropdown['belt_exams']['num_buttons'] ?? 1) === 3 ? 'selected' : ''; ?>>3</option>
                                     </select>
                                </div>
                        ...
                        <div id="menu-items-container">
                            ...
                            if (empty($menu_items)) {
                                $menu_items = [
                                    ...
                                    ['text' => 'Weekend & Evening', 'href' => '#weekend-evening'],
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><code>#weekend-evening</code> - After School/Weekend & Evening programs</li>
