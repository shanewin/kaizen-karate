...
(function() {
    ...
    // Verify classData was injected by PHP
    if (typeof window.classData === 'undefined' || !window.classData) {
        console.error('classData not found. Class schedule cannot be displayed.');
        return;
    }
...
function createClassCard(cls) {
    ...
    if (cls.beltLevel && cls.beltLevel !== 'all') {
        ...
        } else if (cls.beltLevel === 'white-orange') {
            beltBadges = '<span class="belt-level white">White</span><span class="belt-level yellow">Yellow</span><span class="belt-level orange">Orange</span>';
                    ...
                    if (cls.beltLevel === 'green-plus') {
                        ...
                        if (beltSet.size === 0 && !isMixedWithoutSpecificAge) {
                            if (cls.beltLevel === 'white-yellow') {
                                ...
                                // Fallback for white-orange belt level grouping
                                beltBadges = '<span class="belt-level white">White</span><span class="belt-level yellow">Yellow</span><span class="belt-level orange">Orange</span>';
                            } else if (cls.beltLevel === 'green-blue') {
...
function isClassValidForBeltLevel(cls, selectedBeltLevel) {
    ...
    const beltLevelMapping = {
        'white': ['white-yellow', 'white-orange', 'all'],
        'yellow': ['white-yellow', 'white-orange', 'all'],
        'orange': ['white-orange', 'all'],
...
function sortBeltBadges(beltSet) {
    const beltOrder = ['white', 'yellow', 'orange', 'green', 'purple', 'blue', 'brown', 'red'];
